// Helper script to generate a valid prediction (12 groups × 4 teams = 48)
// Run: node test-prediction-helper.js
...
const prediction = {
  groups: {
    ...
    I: shuffled.slice(32, 36),
    J: shuffled.slice(36, 40),
    K: shuffled.slice(40, 44),
    L: shuffled.slice(44, 48),
  },
};
