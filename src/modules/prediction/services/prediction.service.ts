...
//   /**
//    * Submit or update user's prediction
//    */
//   async submitPrediction(
//     userId: string,
//     submitPredictionDto: SubmitPredictionDto,
//   ): Promise<Prediction> {
//     try {
//       // Validate prediction structure
//       await this.validationService.validatePrediction(
...
//         this.validationService.validateCanSubmit(prediction.is_finalized);

//         // Update existing prediction
//         prediction.predict = { groups: submitPredictionDto.groups };
//         prediction.updated_at = new Date();

//         await this.predictionRepository.save(prediction);
//         this.logger.log(`Prediction updated for user ${userId}`);
//       } else {
//         // Create new prediction
//         prediction = this.predictionRepository.create({
//           user_id: userId,
//           predict: { groups: submitPredictionDto.groups },
//           is_finalized: false,
//         });

//         await this.predictionRepository.save(prediction);
//         this.logger.log(`New prediction created for user ${userId}`);
//       }
...
//     if (!prediction) {
//       throw new NotFoundException('No prediction found to finalize');
//     }

//     if (prediction.is_finalized) {
//       throw new BadRequestException('Prediction is already finalized');
//     }
...
//     this.logger.log(`Prediction finalized for user ${userId}`);
//     return prediction;
//   }
...
//     this.logger.log(`Prediction deleted for user ${userId}`);
//   }

//   /**
//    * Get all finalized predictions (for processing)
//    */
//   async getFinalizedPredictions(
//     limit: number = 1000,
//     offset: number = 0,
//   ): Promise<Prediction[]> {
...
//   /**
//    * Get predictions without results (for processing)
//    */
//   async getPredictionsWithoutResults(
//     limit: number = 1000,
//   ): Promise<Prediction[]> {
//     return this.predictionRepository
//       .createQueryBuilder('prediction')
//       .leftJoin('prediction.result', 'result')
...
//       where: { is_finalized: true },
//     });
//     const processed = await this.predictionResultRepository.count();
